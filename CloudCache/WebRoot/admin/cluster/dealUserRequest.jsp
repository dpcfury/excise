...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-md-9" id="usercontent">
				<jsp:include page="dealRequest.jsp"></jsp:include>
			</div>
		</div>
	...
	<script type="text/javascript">
		...
		$(function () {
            $("#createCluster").bind("click", function () {
                $("#operation").show(2000,function(){
                	$("#createCluster").attr("disabled",true);
                });
            });
        });
	</script>
