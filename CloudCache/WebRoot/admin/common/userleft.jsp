	...
	<div class="panel-group" id="accordion" role="tablist"
		...
		<div class="panel panel-success" id="first-panel">
			...
			<div id="collapseOne" class="panel-collapse collapse" role="tabpanel"
				...
				<div class="list-group">
					<a href="ClustercheckSysCluster.action" class="list-group-item"> 查看集群状态<i
						class="fa fa-arrow-right pull-right fa-fw"></i>
					</a> <a href="#" class="list-group-item">集群参数列表<i
						class="fa fa-arrow-right pull-right fa-fw"></i></a> <a href="#"
						class="list-group-item">集群使用日志<i
		...
		<div class="panel panel-success">
			...
			<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
				...
				<div class="list-group">
					<a href="#" class="list-group-item">查看用户集群<i
						class="fa fa-arrow-right pull-right"></i></a> <a href="#"
						class="list-group-item">删除用户集群<i
		...
		<div class="panel panel-success">
			...
			<div id="collapseThree" class="panel-collapse collapse"
				...
				<div class="list-group">
					<a href="#" class="list-group-item">增加缓存<i
						class="fa fa-arrow-right pull-right"></i></a>
				</div>
			</div>
		</div>
