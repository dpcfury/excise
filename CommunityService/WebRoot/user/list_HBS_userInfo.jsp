...
<body>
	<div class="container">
		...
		<table class="table table-striped table-bordered">
			...
			<s:iterator value="#session.HBSUsers" var="userTemp">
				<tr>
					...
					<td class="text-center"><a
						href="chartshowBSRecord.action?userID=<s:property value="#userTemp.userid"/>"
						class=" btn btn-primary btn-sm">血糖记录</a></td>
				</tr>
	...
	<div class="page_choose" style="text-align:center;">
		...
		<ul class="pagination">
			<li id="index_pre"><a
				href="UserlistHBSUserInfo.action?nowPage=${nowPage-1}&menu_index=2"
