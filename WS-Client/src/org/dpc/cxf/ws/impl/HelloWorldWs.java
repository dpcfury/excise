 ...
 * 2014-08-20T13:25:19.990+08:00
 * Generated source version: 3.0.1
 * 
 */
@WebServiceClient(name = "HelloWorldWs", 
                  wsdlLocation = "http://172.25.33.185:8081/crazyit?wsdl",
                  targetNamespace = "http://impl.ws.cxf.dpc.org/") 
public class HelloWorldWs extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://impl.ws.cxf.dpc.org/", "HelloWorldWs");
    public final static QName HelloWorldWsPort = new QName("http://impl.ws.cxf.dpc.org/", "HelloWorldWsPort");
    static {
        URL url = null;
        try {
            url = new URL("http://172.25.33.185:8081/crazyit?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldWs.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://172.25.33.185:8081/crazyit?wsdl");
        }
        WSDL_LOCATION = url;
    }
