...
public class HomeController extends BaseProfileController {
	...
	public ModelAndView index(HttpServletResponse response) {
		System.out.println("跳转到了HomeController 控制器来处理");
		...
		Cookie cookie = new Cookie("uuid", RedisCacheThreadLocal.getUuid());// 在cookie中设置用户id相关的一个ThreadLocal变量
	...
	public ModelAndView chartMemery() {
		...
		ModelAndView mv = getJsonModelAndView();// 这里使用的这的JsonView 通过bean寻找视图
