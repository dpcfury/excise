...
<head>
	...
	<pubTag:resource/>
	<link href="<%=request.getContextPath()%>/resources/json/s.css" rel="stylesheet">
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/json/m.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/json/c.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/xml/formatXML.js"></script>
	<script src="<%=request.getContextPath()%>/js/keys/keys.js"></script>
	<script>
		uuid = '${param.uuid}' ;
		$._messengerDefaults = {
