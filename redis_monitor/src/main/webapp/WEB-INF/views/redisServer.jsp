...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/jquery-easyui-1.3.4/themes/bootstrap/easyui.css">
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/jquery-easyui-1.3.4/themes/icon.css">
    <link href="<%=request.getContextPath()%>/resources/bootstrap-switch/bootstrap-switch.css" rel="stylesheet">
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/bootstrap-switch/bootstrap-switch.js"></script>
    
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/bootstrap/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/bootstrap/js/bootstrap-scrollspy.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/bootstrap/js/bootstrap-button.js"></script>
	
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/jquery-easyui-1.3.4/jquery.easyui.min.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/jquery-easyui-1.3.4/locale/easyui-lang-zh_CN.js"></script>
    <script type="text/javascript" src="<%=request.getContextPath()%>/resources/jquery-easyui-1.3.4/plugins/jquery.dialog.js"></script>
	<title>Angel</title>
...
<body>
    ...
    <table id="dg" title="redis服务列表" class="easyui-datagrid" style="width:700px;height:250px"
            url="<%=request.getContextPath()%>/server/redisServerList.htm"
            toolbar="#toolbar" 
    ...
    <script type="text/javascript">
        ...
        function editUser(){
            ...
            if (row){
                ...
                $('#fm').form('load',row);
                url = '<%=request.getContextPath()%>/updateRedis.htm?id='+row.id;
            }
        }
        function saveUser(){
            $('#newServer').submit();
        	...
        	if (selectRow.length > 0) {
        		$.messager.confirm('确认','您是否要删除当前选中的记录?',function(r){
        			if (r) {
        				...
        				$.ajax({
        					url : '<%=request.getContextPath()%>/server/removeServer.htm',
        					data : {'uuid' : uuid},
        					dataType : 'json',
        					method : 'get',
        					async : false,
        					success : function(result) {
        							...
        							window.location.href = '<%=request.getContextPath()%>/server/redisServer.htm';
	...
	<pubTag:footer/>
          ...
          <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            ...
            <form class="form-horizontal e-form" action="<%=request.getContextPath()%>/server/newServer.htm" method="post" id="newServer">
