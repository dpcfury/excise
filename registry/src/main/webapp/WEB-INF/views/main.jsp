					...
					<div class="span4">
						<table class="table table-striped table-bordered">
							<c:forEach items="${allSubKeys}" var="subKey">
								<tr>
									<td><a
										href="getSubKeysOrValues.htm?current_key_path=${current_key_path}&subKeyName=${subKey}">\&nbsp${subKey}</a></td>
									<td class="text-center"><a
										href="startValueOperation.htm?current_key_path=${current_key_path}&subKeyName=${subKey}"
										class="button button-3d button-action button-pill button-tiny"><i
											class="fa fa-cogs"></i>value operation</a></td>
									<td class="text-center"><a href="deleteKey.htm?current_key_path=${current_key_path}&subKey=${subKey}"
										class="button button-raised button-caution button-tiny"><i
